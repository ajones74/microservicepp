...
int main( int argc, const char **argv )
{
   ...
   try {
      ...
      ///////////////////////////////////////////////////////////////////
      // 
      //  * Instantiate the serial class object
      //  * Create an NNG socket @ ipc:///tmp/GPS_data.ipc
      //  ** PUSH
      //  ** LISTEN
      //  * Create an NNG socket @ ipc:///tmp/GPS_mgmt.ipc -- 
      //  ** RESPOND
      //  ** LISTEN 
      //
      //  * Create a std::thread:
      //  ** Blocking read w/ 1ms timeout of UART
      //  ** Write data to NNG data socket
      //  ** examine/poll the mgmt sockt ( blocking read with 1ms timeout???)
      //  ** Send a status message to the logging Service
      //  ** Return *back* to the blocking read of the UART.
